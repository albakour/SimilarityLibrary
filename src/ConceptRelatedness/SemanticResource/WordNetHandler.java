...
import ConceptRelatedness.SemanticResource.FindLCSAlgorithm;
...
//    }
    ...
    public int getNumberOfConcepts() {
        ...
        int result = entity.countSuccessors() + 1;
        return result;
    }
    ...
    public int getMaxLeaves() {
        ...
        int result = entity.countSuccessorLeaves();
        return result;
    }
    ...
    /**
     * this method is a member in just  WordNetHandler and not overriden because it is not
     * necessary that the ontology which represent the semantic resource to
     * have taxonomy form , so it is not included in semantic resource interface
     *
     * @param parent
     * @param child
     * @return
...
//    }
    ...
    public int getMaxDepth() {
        ...
        Concept entity;
        entity = getWrappingConcepts("entity")[0];
        ConceptNode currentNode = new ConceptNode(entity, null, null);
